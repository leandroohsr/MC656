...
export const CalendarioPage = () => {
    ...
    return (
            <div className="grid grid-cols-7 h-screen">
                <button data-modal-target="default-modal" data-modal-toggle="default-modal" className="border border-black text-black"> Dia 1</button>
                <button onClick={alternPopup} className="border border-black text-black"> Dia 2</button>
                {showPopup && <div id="default-modal" aria-hidden="true" className="overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
